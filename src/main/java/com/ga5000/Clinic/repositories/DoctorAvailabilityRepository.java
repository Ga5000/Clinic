...
public interface DoctorAvailabilityRepository extends JpaRepository<DoctorAvailability, Long> {
    ...
    @Query("SELECT da FROM DoctorAvailability da WHERE da.doctor = :doctor AND da.date = :date AND da.startTime <= :startTime AND da.endTime >= :endTime")
    DoctorAvailability findAvailabilityForDoctor(@Param("doctor") Doctor doctor, @Param("date") LocalDate date,
