...
public interface PatientRepository extends JpaRepository<Patient, String> {
    ...
    // Find a patient by their social security number (SSN)
    ...
    List<Tuple> findAppointmentsFilteredBySpeciality(@Param("ssn") String ssn, @Param("speciality") Speciality speciality);
